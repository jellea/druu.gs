...
App);
App.Events=function(b){function a(a){App.Data.getNextExperience($(".reporttext").attr("id"),$(".reporttext").attr("subid"),a)}b.ready(function(){b.View.Aside.show("#welcome","#substances-aside")});var h=function(a){b.Data.Sql.select("substances",{id:a},function(e){null!=e&&(_gaq.push(["_trackPageview","/#/substance-"+a+""]),b.dom("#welcome header .title").text(e.name),b.dom('a[id="'+a+'"] span.bubble.count').text(e.totalexp),b.dom(".aside-item").removeClass("current"),b.dom('a[id="'+a+'"]').addClass("current"),App.Data.getExperiencesList(e),
